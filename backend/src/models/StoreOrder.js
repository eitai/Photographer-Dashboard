...
// Reporting functions live in a dedicated module for separation of concerns.
// Re-exported here to preserve the existing public API of this module.
const { report, reportForSupplier } = require('./storeOrderReports');
