              ...
              return (
                <FadeIn key={img._id} delay={Math.min(i * 0.03, 0.3)}>
                  ...
                  >
                    ...
                    {/* Hero star — only on selected images */}
                    {isSelected && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setHeroId(heroId === img._id ? null : img._id);
                        }}
                    ...
                    {/* Comment bubble — only on selected images */}
                    {isSelected && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setActiveCommentId(activeCommentId === img._id ? null : img._id);
                        }}
