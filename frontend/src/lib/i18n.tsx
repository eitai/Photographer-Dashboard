...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'admin.products.catalog_subtitle': { he: 'המוצרים שיהיו זמינים בעת יצירת הזמנה ללקוח', en: 'Products available when creating an order for a client' },
  ...
  'products.no_products_desc': { he: 'הצלמ/ת שלך טרם הגדיר/ה מוצרים עבורך.', en: "Your photographer hasn't set up any products for you yet." },
  ...
  'landing.feature.upload.desc':     { he: 'מעלים עד 1,000 תמונות בבת אחת — המערכת מבצעת אופטימיזציה אוטומטית. הלקוח מקבל קישור פרטי, לא קישור WeTransfer.', en: 'Bulk-upload 1,000 photos with auto-optimization. Clients get a private link, not a zip file.' },
  'landing.feature.alerts.title':    { he: 'עדכונים בזמן אמת',                   en: 'Instant Client Alerts' },
  'landing.feature.alerts.desc':     { he: 'מקבלים התראה ברגע שלקוח פתח את הגלריה או שלח בחירות. לא צריך לרדוף אחרי אף אחד.', en: 'Get notified the second a client views their gallery or submits a selection. Zero chasing.' },
  'landing.feature.pipeline.title':  { he: 'Pipeline מעקב עבודות',               en: 'Selection Pipeline' },
  'landing.feature.pipeline.desc':   { he: 'כל עבודה בסטטוס ברור: נשלחה ← נצפתה ← בחירות התקבלו ← בעריכה ← נמסרה. שום עבודה לא נופלת בין הכיסאות.', en: 'Track every job: Gallery Sent → Viewed → Selections In → Editing → Delivered. Nothing falls through.' },
  'landing.feature.store.title':     { he: 'חנות מוצרים מובנית',                 en: 'Built-in Product Store' },
  'landing.feature.store.desc':      { he: 'מוכרים אלבומים, הדפסים וקנבסים ישירות בתוך הגלריה. ההזמנות מגיעות לדשבורד — בלי אינטגרציות חיצוניות.', en: 'Sell albums, prints, and canvases without a third-party cart. Orders land right in your dashboard.' },
  'landing.feature.themes.title':    { he: '11 תבניות לתיק העבודות',              en: '11 Portfolio Themes' },
  'landing.feature.themes.desc':     { he: 'דף תיק עבודות ציבורי, 11 תבניות מעוצבות, מיתוג מלא. עולה לאוויר תוך 5 דקות.', en: 'Your public portfolio, 11 themes, fully brandable. Live in 5 minutes.' },
  'landing.feature.bilingual.title': { he: 'עברית ואנגלית — ילידים',              en: 'Hebrew & English' },
  'landing.feature.bilingual.desc':  { he: 'תמיכה מלאה ב-RTL/LTR — ממשק, גלריות, התראות וחוויית הלקוח בשתי השפות, ללא פשרות.', en: 'Full RTL/LTR — galleries, notifications, and the client experience, in both languages.' },
  ...
  'landing.step.1.desc':  { he: 'בוחרים את התמונות, גוררים פנימה. המערכת מטפלת בשינוי גודל, דחיסה ואחסון — הכל אוטומטי.', en: 'Select your exported images and drag them in. We resize, compress, and store everything automatically.' },
  'landing.step.2.title': { he: 'שיתוף',  en: 'Share' },
  'landing.step.2.desc':  { he: 'בלחיצה אחת נוצר קישור גלריה פרטי ללקוח — עובד על כל טלפון, טאבלט ומחשב, ללא הורדת אפליקציה.', en: 'One click generates a private gallery link for your client — works on any phone, tablet, or desktop.' },
  'landing.step.3.title': { he: 'בחירה',  en: 'Select' },
  'landing.step.3.desc':  { he: 'הלקוחות גולשים, מסמנים מועדפות ושולחים — הכל בתוך הגלריה הפרטית שלהם. ללא אפליקציה, ללא הרשמה.', en: 'Clients browse, heart their favourites, and submit — all inside their private gallery. No app needed.' },
  'landing.step.4.title': { he: 'מסירה',  en: 'Deliver' },
  'landing.step.4.desc':  { he: 'עוברים על הבחירות, מטפלים בהזמנות מוצרים, מסמנים את העבודה כנמסרה. ה-pipeline מתקדם מעצמו.', en: 'Review selections, process product orders, mark the job Delivered. The pipeline moves itself.' },
  ...
  'landing.tracking.p1':             { he: 'רואים בדיוק איפה עומדת גלריית החתונה של שרה ודוד — בלי לשלוח ולו מייל מעקב אחד.', en: "Know exactly where Sarah's wedding gallery stands — without sending a single follow-up email." },
  'landing.tracking.p2':             { he: 'התראות חיות מגיעות ברגע שלקוח פתח את הגלריה, סימן מועדפת, או הזמין מוצר. ה-pipeline מתעדכן אוטומטית — בלי עבודה ידנית.', en: 'Live notifications fire the moment a client views their gallery, marks a favourite, or places a product order. Your pipeline updates itself.' },
  ...
  'landing.notif.2.sub':   { he: 'פורטרט עסקי · תמונות לינקדאין · לפני 18 דקות', en: 'Portrait session · Corporate headshots · 18 min ago' },
  ...
  'landing.brand.desc':           { he: 'בוחרים מאחת-עשרה תבניות מעוצבות — Soft, Luxury, Midnight, Bold ועוד. מתאימים צבעים, גופנים וטקסטים. דף תיק העבודות שלכם עולה לאוויר תוך דקות. ללא מעצבים. ללא קוד.', en: 'Pick from eleven hand-crafted themes — Soft, Luxury, Midnight, Bold, and more. Customise colours, fonts, and copy. Your public portfolio is live in minutes. No designers. No code.' },
  ...
  'landing.products.desc':           { he: 'מציעים מוצרים פיזיים ישירות בתוך גלריית הלקוח. הלקוחות בוחרים, אתם מממשים — ללא אינטגרציות חיצוניות, ללא עמלות לצד שלישי.', en: 'Offer physical products directly inside the client gallery. Clients choose, you fulfil — no third-party integrations, no extra subscriptions.' },
  ...
  'landing.bilingual.desc':  { he: 'תמיכה ילידית מלאה ב-RTL וב-LTR — ממשק הניהול, הגלריות, ההתראות ודפי הלקוח — הכל זמין בעברית ובאנגלית, ללא תוספות.', en: 'Full native RTL/LTR support — interface, galleries, notifications, and client pages in both languages.' },
  ...
  'landing.testimonial.1.quote':      { he: 'סוף סוף מערכת שמבינה איך צלמים עובדים בפועל. לא עוד גוגל שיטס ו-WeTransfer.', en: 'Finally, a tool that understands how photographers actually work.' },
  ...
  'landing.testimonial.2.quote':      { he: 'הלקוחות שלי מתאהבים בחוויית הגלריה. בחירות שנהגו לקחת שבועות — היום מסתיימות תוך יומיים.', en: "My clients love their private gallery experience. Selections used to take weeks — now it's days." },
  ...
  'landing.testimonial.3.quote':      { he: 'ה-pipeline הוא המשחק-מחליף בשבילי. אני רואה בדיוק באיזה שלב כל עבודה, בלי לחפש בוואטסאפ.', en: 'The pipeline view is everything. I know exactly where every job stands at a glance.' },
  ...
  'landing.cta.desc':           { he: 'הצטרפו לצלמים שמעניקים ללקוחותיהם חוויה שאי אפשר לשכוח — עם Koral Light Studio.', en: 'Join photographers delivering better client experiences with Koral Light Studio.' },
