...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'admin.clients.wizard.products_partial_fail': { he: 'הלקוח נוצר, אך חלק מהמוצרים לא נוצרו. ניתן להוסיפם מדף הלקוח.', en: 'Client created, but some product orders failed. Add them from the client page.' },
  ...
  'selection.submitted.body': { he: 'הבחירה שלך התקבלה. הצלם יצור איתך קשר בקרוב.', en: 'Your selection has been received. The photographer will be in touch soon.' },
